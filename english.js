...
$(function(){
  ...
  $("#part1").click(function () {setTimeout('$(".p1").fadeIn();',500);});
  $("#part2").click(function () {setTimeout('$(".p2").fadeIn();',500);});
  ...
  //Part2
  $("#button3_2_0").click(function () { x = 401; 	y = 520;});
  $("#button3_2_1").click(function () { x = 401; 	y =  458;});
  $("#button3_2_2").click(function () { x = 459; 	y =  520;});
  $("#button3_2_3").click(function () { x = 521; 	y =  582;});
