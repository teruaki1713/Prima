...
var hanni = [
  ...
  [
    [401,458] , [459,520],[521,582],[583,624],[625,666],[667,706],[707,752],[753,796],[797,839],[840,878]
  ]
]
...
function DrawAll() {
  for(var consoleNumber = 0; consoleNumber < words.length; consoleNumber++) {
    console.log(consoleNumber+1 + "-" + words[consoleNumber][0]+" : "+words[consoleNumber][1])
  };
}
...
$(function(){
  ...
  let words =
   ...
   ["valid","妥当な"]/*第14回*/, ["available","手に入る"], ["casual","気楽な"], ["rare","珍しい"], ["practical","現実的な"],
